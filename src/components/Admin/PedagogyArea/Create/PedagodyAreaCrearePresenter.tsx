...
interface PedagogyAreaCreatePresenterProps {
    ...
    onChangeValue : (root:string, name: string, value: string , index: number) => void;
}
                ...
                <section className="container px-4 mx-auto">
                    ...
                    <div className="mt-10">
                        ...
                        <div className="flex flex-col m-2">
                                    ...
                                    <>
                                        <div className="flex flex-row">
                                            <div className="flex flex-col w-full m-2">
                                                ...
                                                value={e.title}
                                                disabled={!_edit}
                                                onChange={(value) => props.onChangeValue("normatives", "title", value.target.value, i)}
                                                ...
                                                value={e.description}
                                                disabled={!_edit}
                                                onChange={(value) => props.onChangeValue("normatives", "description", value.target.value, i)}
                                                ...
                                                value={e.url}
                                                disabled={!_edit}
                                                onChange={(value) => props.onChangeValue("normatives", "url", value.target.value, i)}
                                                />
                                            </div>
                                            <div className="flex flex-col m-2">
                                                {
                                                    ...
                                                    <div className="rounded-full border bg-red-500 border-red-500 w-7 h-7 flex items-center justify-center">
                                                        <button type="button" onClick={() => props.onDropNormative(i)}>
                            ...
                            {
                                _edit && <div className="flex items-center justify-center w-full mt-5">
                                    ...
                                    <>
                                        <div className="flex flex-row">
                                            <div className="flex flex-col w-full m-2">
                                                ...
                                                value={e.title}
                                                disabled={!_edit}
                                                onChange={(value) => props.onChangeValue("tutorials", "title", value.target.value, i)}
                                                />

                                                <Input placeholder="Descripción" 
                                                value={e.description}
                                                disabled={!_edit}
                                                onChange={(value) => props.onChangeValue("tutorials", "description", value.target.value, i)}
                                                />

                                                <Input placeholder="URL" 
                                                value={e.url}
                                                disabled={!_edit}
                                                onChange={(value) => props.onChangeValue("tutorials", "url", value.target.value, i)}
                                                />
                                            </div>
                                            <div className="flex flex-col m-2">
                                                {
                                                    _edit &&
                                                    <div className="rounded-full border bg-red-500 border-red-500 w-7 h-7 flex items-center justify-center">
                                                        <button type="button" onClick={() => props.onDropTutorial(i)}>
                                                            <FaTrash className="text-white" />
                                                        </button>
                                                    </div>
                            ...
                            <div className="flex items-center justify-center w-full mt-5">
                                {
                                    ...
                                    _edit && <button type="button" onClick={() => {
                                        props.onAddQuestion();
                                    }}
                                        className="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide
                                                    text-white transition-colors duration-200 bg-primary-300 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-primary-600 
