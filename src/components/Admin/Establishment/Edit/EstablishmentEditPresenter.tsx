          ...
          <div className="mt-10">
            ...
            <div className="grid xl:grid-cols-1 gap-4">
              ...
              <div className="flex  flex-col m-2">
                <Input
                  type={"text"}
                  placeholder={"Nombre de la autoridad superior"}
                  width="w-60"
              ...
              <div className="flex  flex-col m-2">
                <Input
                  type={"text"}
                  placeholder={"Apellido de la autoridad superior"}
                  width="w-60"
              ...
              <div className="flex  flex-col m-2">
                <Input
                  type={"text"}
                  placeholder={"Cargo de la autoridad superior"}
                  width="w-60"
              ...
              <div className="flex  flex-col m-2">
                <Input
                  type={"email"}
                  placeholder={"Correo de la autoridad superior"}
                  width="w-60"
              ...
              <div className="flex  flex-col m-2">
                <Input
                  type={"text"}
                  placeholder={"Nombre del Responsable del Comité "}
                  width="w-60"
              ...
              <div className="flex  flex-col m-2">
                <Input
                  type={"text"}
                  placeholder={"Apellido del Responsable del Comité "}
                  width="w-60"
              ...
              <div className="flex  flex-col m-2">
                <Input
                  type={"text"}
                  placeholder={"Cargo del Responsable del  Comité"}
                  width="w-60"
              ...
              <div className="flex  flex-col m-2">
                <Input
                  type={"email"}
                  placeholder={"Correo del Responsable del comité"}
                  width="w-60"
              ...
              <div className="flex  flex-col m-2">
                <Input
                  type={"email"}
                  placeholder={"Correo de acceso a la info"}
                  width="w-60"
              ...
              <div className="flex items-center gap-x-3">
                <ReactSelect
                  ...
                  onChange={(selectedOptions) => {
                    // Delegar la eliminación si corresponde
                    const selectedIds =
                      selectedOptions?.map((option) => option.value) || [];
                    const removedIds = props
                      .getSelectedExtraNumeral(props.data.extra_numerals || "")
                      .map((numeral) => numeral.value)
                      .filter((id) => !selectedIds.includes(id));

                    removedIds.forEach((id) => {
                      props.handleRemoveNumeral(id); // Llama a tu función específica para eliminaciones
                    });

                    props.hangelChangeExtraNumeral(selectedOptions); // Actualiza el estado general
                  }}
                  value={props.getSelectedExtraNumeral(
                    props.data.extra_numerals || "",
                  )}
                />
              </div>
            </div>
