  ...
  return (
    <>
      ...
      <p className="my-8 max-w-3xl items-center text-sm text-primary">
        En esta sección podrás visualizar, editar, activar e inactivar los
        usuarios del portal, así como crear nuevos usuarios.
      </p>
        ...
        <div className="flex flex-row gap-6 w-full">
          ...
          <div className="flex flex-row gap-2">
            <div className="flex flex-col ">
              <label className="text-gray-500 text-sm">Limite</label>
              <Select
                options={[
                  {
                    label: "5",
      ...
      <Modal isvisible={props.visibleModal} onClose={() => {}}>
        ...
        <div className="flex justify-center gap-4">
          <button
            ...
            className="flex w-full max-w-24 items-center gap-2 rounded-md border border-primary bg-primary px-2 py-1 text-xs font-medium text-white hover:bg-transparent hover:text-primary"
          >
            {"Si, Estoy seguro"}
          </button>
          <button
