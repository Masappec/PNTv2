...
const IndicatorsEstablishment = (props: Props) => {
  ...
  return (
    <>
      <section
        className="my-16 flex flex-col gap-y-4 md:flex-row md:items-end"
        id="indicadores"
      >
      ...
      <div className="flex flex-row gap-1">
        <div className="container px-3 relative w-3/5">
          <div className="h-full border rounded-2xl  p-6">
            ...
            <h2 className="text-2xl mt-2 font-extrabold"></h2>
            <Chart
              options={score}
              series={score.series}
              type="radialBar"
            ...
            <div className="flex flex-row mt-4 border-2 border-black ">
              <div className="flex-col border-r-2 border-black">
                <img
                  src={props.qrUrl}
                  alt="Insignia Digital de Transparencia"
                />
              </div>
              <div className="flex-col ml-2 ">
                <p className="text-sm">{props.establishment_name}</p>
      ...
      <div className="flex flex-row gap-1 ">
        <div className="flex flex-col items-center p-4 h-52">
          <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-6 max-w-md w-full">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">
              Cantidad total de solicitudes de información recibidas en{" "}
              {new Date().getFullYear()}:
            </h2>
            <div className="bg-blue-100 border border-blue-200 text-blue-800 rounded-lg px-4 py-2 text-center">
              <h4 className="text-2xl font-bold">{res.total_recibidas}</h4>
            </div>
          </div>
        </div>
        <div className="flex flex-col items-center p-4 h-52">
        ...
        <div className="flex flex-col items-center p-4 h-52">
          <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-6 max-w-md w-full">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">
              Día del mes donde frecuentemente se publican los archivos de
              transparencia:
            </h2>
      ...
      <div className="flex flex-row gap-1 mt-11">
        <div className="flex flex-col items-center p-4 h-52">
          <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-6 max-w-md w-full">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">
              Cantidad total de archivos de transparencia activa publicados en{" "}
              {new Date().getFullYear()}:
            </h2>
            <div className="bg-blue-100 border border-blue-200 text-blue-800 rounded-lg px-4 py-2 text-center">
              <h4 className="text-2xl font-bold">{res.ta_published}</h4>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center p-4 h-52">
          <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-6 max-w-md w-full">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">
              Cantidad total de archivos de transparencia focalizada publicados
        ...
        <div className="flex flex-col items-center p-4 h-52">
          <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-6 max-w-md w-full">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">
              Cantidad total de archivos de transparencia colaborativa
              publicados en {new Date().getFullYear()}:
            </h2>
            <div className="bg-blue-100 border border-blue-200 text-blue-800 rounded-lg px-4 py-2 text-center">
              <h4 className="text-2xl font-bold">{res.ta_published}</h4>
            </div>
