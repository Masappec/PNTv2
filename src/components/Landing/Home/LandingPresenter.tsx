      ...
      <div className="border-l-2 border-gray-500 ml-8 md:ml-14">
        ...
        justify-center  mb-44 ">
          ...
          <CardConsulta
            ...
            title="Presupuestos"
            backgroundColor="hover:bg-[#BFE413] bg-[#F1F7D1] px-5 w-full"
            color="text-black"
            classnames={"px-5 xl:mr-0 "}
            content=" Encontrarás información sobre presupuesto participativo, consejo de coordinación regional, audiencias públicas, entre otros."
          ...
          <CardConsulta
            ...
            backgroundColor="hover:bg-[#65FFF8] bg-[#E7FFFE] px-5 w-full"
            color="text-black"
            classnames={"px-5 xl:mr-0 "}
            content=" Encontrarás información sobre presupuesto participativo, consejo de coordinación regional, audiencias públicas, entre otros."
