...
import SolicitiesResponsePresenter from "./SolicitiesResponsePresenter"
...
const SolicitiesResponseContainer = (props: Props) => {
    ...
    const onExport = () => {
        props.reportApi.generateReportSolicitiesResponse(new Date().getFullYear()).then(response => {
            const url = window.URL.createObjectURL(new Blob([response]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'reporte-solicitudes-con-respuesta.xlsx');
...
export default SolicitiesResponseContainer;