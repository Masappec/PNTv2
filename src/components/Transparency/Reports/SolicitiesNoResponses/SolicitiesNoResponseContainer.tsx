...
import SolicitiesNoResponsePresenter from "./SolicitiesNoResponsePresenter"
...
const SolicitiesNoResponseContainer = (props: Props) => {
    ...
    const onExport = () => {
        props.reportApi.generateReportNoSolicities(new Date().getFullYear()).then(response => {
            const url = window.URL.createObjectURL(new Blob([response]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'reporte-solicitudes-sin-respuesta.xlsx');
...
export default SolicitiesNoResponseContainer;