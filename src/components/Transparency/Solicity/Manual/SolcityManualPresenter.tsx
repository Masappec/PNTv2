  ...
  return (
    <>
      ...
      <h2 className="text-xs  text-primary">
        En esta opción puedes cargar una solicitud de acceso a la información
        que se haya recibido en formato físico o por otro medio que no sea este
        portal. Completa la información requerida para registrarla.
      </h2>
            ...
            {!props.disabledReceipt ? (
              <div>
                <label
                  ...
                  data-testid="flowbite-label"
                >
                  Formato Requerido para Respuesta
                </label>
                <select
                  className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 outline-primary focus:border-cyan-500 focus:ring-cyan-500 disabled:cursor-not-allowed disabled:opacity-50"
                  onChange={(value) => {
