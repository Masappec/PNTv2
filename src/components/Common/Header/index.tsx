            ...
            <nav className="bg-white border-gray-900 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2">
                        <Link to="/entidades"
                        tabIndex={2}
                        className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-11 py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">
                        ...
                        className="text-white bg-primary-600
                         ...
                         focus:ring-blue-300 font-medium rounded-3xl text-sm px-11 py-2.5 mr-2
