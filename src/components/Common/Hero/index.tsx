...
const Hero = () => {
    ...
    return (
        <section className=" dark:bg-gray-900 mt-2 ">
            <div className="grid max-w-screen-xl ml-10 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-10 ">
                <div className="lg:col-span-2  justify-start  ">
                    <p className="text-xl font-bold text-gray-800 dark:text-white w-11/12 lg:w-32 " tabIndex={6}>
                ...
                <div className="lg:col-span-8 lg:flex-row lg:justify-end lg:items-center lg:space-x-4 lg:space-y-0 lg:flex">
                    <div className="flex flex-col items-center justify-center w-full">
                        <p className="text-4xl font-medium text-gray-800 dark:text-white w-11/12 lg:w-[52%] " tabIndex={7}>
                            <FormattedMessage id="title_search_entities" />
                        </p>
                        <div className="search mt-20 lg:mt-8 w-full justify-center flex ml-20  ">
                            ...
                            <TextInput id="buscar" type="text" icon={FaSearch}
                                ...
                                className="w-6/12 h-12 mt-4 mr-[110px] pb-14  "
                                tabIndex={7}
                        ...
                        <p className="text-base font-normal  text-gray-800 dark:text-white w-11/12 lg:w-[52%] mt-4" tabIndex={8}>
                            <FormattedMessage
