...
export const inputSearchThemeMobile: CustomFlowbiteTheme['textInput'] = {
    base: 'w-full rounded-3xl ',
    field: {
        input: {
            base: 'w-[100%] rounded-[59px] text-sm border-2 ',
            sizes: {
                'sm': 'h-8 text-xs',
                'md': 'h-12 px-4 text-sm',
                'lg': 'h-[56px]  text-lg'
            ...
            colors: {
                'gray': 'dark:bg-gray-500 dark:text-white border-gray-900  dark:border-gray-600 focus:ring-0 focus:ring-gray-500 focus:border-gray-500',
            },
            withShadow: {
                on: "shadow-md  dark:shadow-none",
                off: "shadow-none"
